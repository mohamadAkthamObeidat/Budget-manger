        ...
        return (
            <div className='body'>
                ...
                <div className="user-info">
                    ...
                    <p className="balance">Current Balance: {this.state.balance} {this.state.currency} </p>
                </div>

                <div className="add-payment">
                    <button type="button" data-toggle="modal" data-target="#exampleModal" onClick={this.addPaymentHandler}> <img src={require('../../Assets/cash.svg')} alt="" /> Add a Payment</button>
                </div>
                {
                    this.state.expenses.length === 0 ?
                        ...
                        <table>
                            ...
                            <tbody>
                                {this.state.expenses.map(element => <Row key={element._id} expenses={element} edit={this.updateExpenses} remove={this.deleteExpense} />)}
                            </tbody>
                        </table>
                }
