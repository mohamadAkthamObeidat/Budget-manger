...
export class Row extends Component {
    ...
    handleEdit = (event) => {
        ...
        this.props.edit(this.props.expense._id, this.state.newExpense, this.clearInputs)
    }
    ...
    render() {
        ...
        return (
            <tr>
                ...
                <td><button type="button" data-toggle="modal" data-target="#exampleModal" onClick={this.handleEdit} className='btn'><img className='icons' src={require('../../Assets/edit.svg')} alt=""/></button></td>
                <td><button onClick={this.handleDelete} className='btn'><img className='icons' src={require('../../Assets/delete.svg')} alt=""/></button></td>
            </tr>
        )
    }
}
